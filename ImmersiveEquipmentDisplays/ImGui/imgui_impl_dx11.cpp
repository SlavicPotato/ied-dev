...
//  ImTextureID. Read the FAQ about ImTextureID! [X] Renderer: Support for large
//  meshes (64k+ vertices) with 16-bit indices.
...
//  2019-08-01: DirectX11: Fixed code querying the Geometry Shader state (would
//  generally error with Debug layer enabled). 2019-07-21: DirectX11: Backup,
//  clear and restore Geometry Shader is any is bound when calling
//  ImGui_ImplDX10_RenderDrawData. Clearing Hull/Domain/Compute shaders without
//  backup/restore. 2019-05-29: DirectX11: Added support for large mesh (64K+
//  vertices), enable ImGuiBackendFlags_RendererHasVtxOffset flag. 2019-04-30:
//  DirectX11: Added support for special ImDrawCallback_ResetRenderState
//  callback to reset render state. 2018-12-03: Misc: Added #pragma comment
//  statement to automatically link with d3dcompiler.lib when using
//  D3DCompile(). 2018-11-30: Misc: Setting up io.BackendRendererName so it can
//  be displayed in the About Window. 2018-08-01: DirectX11: Querying for
//  IDXGIFactory instead of IDXGIFactory1 to increase compatibility. 2018-07-13:
//  DirectX11: Fixed unreleased resources in Init and Shutdown functions.
//  2018-06-08: Misc: Extracted imgui_impl_dx11.cpp/.h away from the old
//  combined DX11+Win32 example. 2018-06-08: DirectX11: Use
...
//  callback and exposed ImGui_ImplDX11_RenderDrawData() in the .h file so you
...
//  CreateContext/DestroyContext themselves. 2016-05-07: DirectX11: Disabling
//  depth-write.
