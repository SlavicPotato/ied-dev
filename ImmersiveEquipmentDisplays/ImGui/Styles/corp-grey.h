...
namespace IED
{
	namespace UI
	{
		namespace Styles
		{
			namespace CorporateGrey
			{
				inline void Setup(ImGuiStyle& a_style, bool a_flat)
				{
					...
					a_style.PopupRounding = 3;

					a_style.WindowPadding = ImVec2(4, 4);
					a_style.FramePadding  = ImVec2(6, 4);
					a_style.ItemSpacing   = ImVec2(6, 2);

					a_style.ScrollbarSize = 18;
					...
					if (ImGui::GetIO().ConfigFlags & ImGuiConfigFlags_ViewportsEnable)
					{
						...
						a_style.Colors[ImGuiCol_WindowBg].w = 1.0f;
					}
#endif
				}
			}
