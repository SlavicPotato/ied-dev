...
namespace IED
{
	...
	NodeOverrideData::NodeOverrideData() :
		...
		m_mov(std::initializer_list<init_list_cm>{
			...
			{ "MOV WeaponAxeReverse", { "Axe Reverse", "MOV WeaponAxeReverse", WeaponPlacementID::AxeReverse } },
			{ "MOV WeaponAxeLeftReverse", { "Axe Reverse Left", "MOV WeaponAxeLeftReverse", WeaponPlacementID::AxeReverse } },
